...
def calculate_similarity(v1, v2):
    ...
    if v1['names_set'] & v2['names_set']:
        ...
        if v1['names_words_set'] and v2['names_words_set']:
            result += 0.5 * tanimoto_similarity(v1['names_words_set'], v2['names_words_set'])

        if v1['title_words_set'] and v2['title_words_set']:
            result += 0.2 * tanimoto_similarity(v1['title_words_set'], v2['title_words_set'])

        if v1['affiliation_set'] and v2['affiliation_set']:
            result += 0.2 * tanimoto_similarity(v1['affiliation_set'], v2['affiliation_set'])

        if v1['keyword_set'] and v2['keyword_set']:
            result += 0.1 * tanimoto_similarity(v1['keyword_set'], v2['keyword_set'])
